...
PyMODINIT_FUNC MODINIT(combinatorics) (void);
PyMODINIT_FUNC MODINIT(lcmath) (void);

static struct _inittab inittab[] = {
    {"combinatorics", MODINIT(combinatorics)},
    {"lcmath", MODINIT(lcmath)},
    {NULL, NULL}
};
...
static int python_main(int argc, wchar_t **argv) {
    ...
    __pyx_module_is_main_combinatorics = 1;
